...
class Locadora:
    ...
    def imprimir(self):
        ...
        for chave, valor in self.equipamentos_D.items():
            print(
                f"{chave} \t\t {valor.get('equipamento')}\t [{valor.get('estado')}]")
    ...
    def emprestimo(self):
        ...
        if id_Equipamento in self.equipamentos_D.keys():
            if self.equipamentos_D[id_Equipamento]["estado"] == 'disponivel':
                ...
                print(
                    f"Esse equipamento foi emprestado para {self.equipamentos_D[id_Equipamento]['nome_Empr']} em {self.equipamentos_D[id_Equipamento]['data_Empr']}")
    ...
    def adicionar(self):
        ...
        if nome_Equipamento == '':
            ...
            with open(self.lista_equipamentos, 'a') as equipamento:
                ...
                self.equipamentos_D.update({str(int(max(self.equipamentos_D)) + 1): {
                                           "equipamento": nome_Equipamento, "nome_Empr": '', "data_Empr": '', "estado": 'desponivel'}})
